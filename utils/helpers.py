...
def _is_valid_stream_url(url: str) -> bool:
    ...
    # SSRF protection: block private/reserved IPs (including DNS resolution)
    try:
        ...
        if hostname:
            ...
            try:
                ...
                # Hostname (not IP literal) — resolve and check all addresses
                try:
                    ...
                    pass  # DNS resolution failed — allow (will fail on connect)
    except Exception:
        return False
