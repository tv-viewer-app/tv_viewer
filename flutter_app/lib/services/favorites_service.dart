...
/// Security note (Issue #106): On Android, SharedPreferences data is stored
/// in the app's private directory (/data/data/<package>/shared_prefs/) which
/// is sandboxed by the OS — only this app can access it. This is sufficient
/// protection for favorite channel URLs.
