...
class M3UService {
  ...
  static const Map<String, List<String>> _channelAliases = {
    // Israeli TV channels
    'kan 11': ['kan 11 news', 'kan 11 subtitled', 'kan 11 4k', 'כאן 11', 'kan 11 israel', 'israel kan 11', 'ערוץ 11', 'כאן'],
    'kan kids': ['kan kids / kan educational', 'kan kids / educational', 'kan educational', 'kan edu', 'כאן חינוכית'],
    'kan bet': ['kan reshet bet', 'kan bet / reshet bet', 'kan israel reshet bet', 'רשת ב', 'reshet bet'],
    ...
    'reshet 13': ['reshet 13 alt', 'reshet 13 subtitled', 'רשת 13', 'ערוץ 13'],
