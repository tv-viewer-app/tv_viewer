...
### Fixed
- Remove Flutter's unused Play Store deferred-component manager and its splitinstall references from F-Droid APKs
...
- Reliable-first browsing hides broken channels with 5+ reports by default and adds a Show all channels toggle
...
### Fixed
- F-Droid: disabled DependencyInfoBlock (encrypted Google metadata removed from APK)
- F-Droid: added ProGuard rules to remove splitinstall classes
- Required for F-Droid MR #39248 approval
